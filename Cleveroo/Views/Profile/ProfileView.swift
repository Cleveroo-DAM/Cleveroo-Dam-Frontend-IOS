                ...
                VStack(spacing: 25) {
                    ...
                    VStack(spacing: 15) {
                        ...
                        if viewModel.isParent {
                            ...
                            // Navigation vers le contrôle parental
                            NavigationLink(destination: ParentChildrenManagementView().environmentObject(viewModel)) {
                                HStack {
                                ...
                                .frame(maxWidth: .infinity)
                                .padding()
                                .background(LinearGradient(colors: [Color.orange, Color.red.opacity(0.8)],
                                                           startPoint: .leading, endPoint: .trailing))
                                .foregroundColor(.white)
                                .clipShape(Capsule())
                                .shadow(radius: 5)
                            ...
                            // Navigation vers les demandes de déblocage
                            NavigationLink(destination: AllUnblockRequestsView()) {
                                HStack {
                                    Image(systemName: "hand.raised.fill")
                                    Text("Demandes de déblocage")
                                }
                                .fontWeight(.bold)
                                .frame(maxWidth: .infinity)
                                .padding()
                                .background(LinearGradient(colors: [Color.indigo, Color.purple.opacity(0.8)],
                                                           startPoint: .leading, endPoint: .trailing))
                                .foregroundColor(.white)
                                .clipShape(Capsule())
                                .shadow(radius: 5)
